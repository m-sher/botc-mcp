...
fn tool_description(name: &str) -> &'static str {
    match name {
        ...
        "nominate" => "Player nominate a living seat (usually auto-yes for the nominator; Butler still needs master yes before their vote can land)",
        "vote" => "Player cast yes/no on the open nomination (once per seat; nominator usually already auto-yesed unless Butler-blocked; a second vote on the same nomination is rejected)",
