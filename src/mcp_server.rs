...
fn tool_description(name: &str) -> &'static str {
    match name {
        ...
        "nominate" => "Player nominate a living seat (counts as an automatic yes vote; you do not vote again on your own nomination)",
        "vote" => "Player cast yes/no on the open nomination (once per seat; nominator already voted yes; a second vote on the same nomination is rejected)",
